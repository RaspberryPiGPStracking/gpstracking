...
<h1 class="header">Welcome to GPS Tracking System</h1>
	
<div class="span1" style="text-align: center;margin-top: 50px">
    <a href="user_selection.php" class="btn btn-primary">
        <i class="icon-pencil icon-white"></i>
	   <p> click on for Existing user </p><br> 
...
<div class="span1" style="text-align: center;margin-top: 50px">
    <a href="new_user.php" class="btn btn-primary">
	   ...
	   <p> click on for Adding user </p><br>
